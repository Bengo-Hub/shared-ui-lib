...
function TreasuryPaymentModal({
  ...
  if (!open) return null;
  return /* @__PURE__ */ jsxs("div", { className: "fixed inset-0 z-50 flex items-start sm:items-center justify-center", children: [
    /* @__PURE__ */ jsx(
      "div",
      {
        className: "absolute inset-0 bg-black/50",
    ...
    /* @__PURE__ */ jsxs("div", { className: "relative w-full sm:max-w-lg sm:mx-4 bg-white sm:rounded-2xl shadow-xl overflow-hidden flex flex-col h-dvh sm:h-auto sm:max-h-[92vh]", children: [
...
export { OfflineBar, OfflineSyncBanner, PdfPreview, PwaUpdater, SSOLoginModal, SupplierForm, SyncedConfirmation, TrackingIframeModal, TreasuryPaymentModal, registerServiceWorker, useDocumentPreview, useOfflineSync, useOnlineStatus };
