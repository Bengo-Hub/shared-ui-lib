...
function TreasuryCheckoutModal({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "fixed inset-0 z-50 flex items-center justify-center", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "relative w-full max-w-lg mx-4 bg-white rounded-2xl shadow-xl overflow-hidden max-h-[90vh] flex flex-col", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "flex-1 min-h-0 relative", children: paymentState === "confirmed" && paymentResult ? /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center py-12 px-6 text-center", children: [
...
export { SSOLoginModal, TrackingIframeModal, TreasuryCheckoutModal };
