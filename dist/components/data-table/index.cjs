...
function DataTable(props) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: cx("space-y-3", props.className), children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "hidden md:block rounded-lg border border-border overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntime.jsx(
        "div",
        {
          className: "overflow-auto",
          style: maxBodyHeight ? { maxHeight: maxBodyHeight } : void 0,
          children: /* @__PURE__ */ jsxRuntime.jsxs("table", { className: "w-full text-sm", children: [
            /* @__PURE__ */ jsxRuntime.jsx("thead", { className: "sticky top-0 z-10 bg-muted", children: /* @__PURE__ */ jsxRuntime.jsxs("tr", { className: cx("border-b border-border bg-muted/40", gridLines === "both" && "divide-x divide-border/50"), children: [
