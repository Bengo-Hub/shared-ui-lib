...
var SERVICE_REGISTRY = [
  // Commerce
  { key: "pos", label: "POS", Icon: lucideReact.ShoppingCart, category: "Commerce", color: "violet", manageOnly: false, serviceTag: "pos", status: "live" },
  { key: "inventory", label: "Inventory", Icon: lucideReact.Package, category: "Commerce", color: "blue", manageOnly: false, serviceTag: "inventory", status: "live" },
  { key: "ordering", label: "Online Store", Icon: lucideReact.Globe, category: "Commerce", color: "emerald", manageOnly: false, serviceTag: "ordering", status: "live" },
  // Operations
  ...
  // Platform
  { key: "auth", label: "Account Portal", Icon: lucideReact.BookOpen, category: "Platform", color: "violet", manageOnly: false, status: "live" },
  { key: "mail", label: "Mail", Icon: lucideReact.Mail, category: "Platform", color: "fuchsia", manageOnly: false, status: "live" },
  { key: "notifications", label: "Notifications", Icon: lucideReact.Bell, category: "Platform", color: "amber", manageOnly: true, status: "live" },
  { key: "ticketing", label: "Ticketing", Icon: lucideReact.Ticket, category: "Platform", color: "rose", manageOnly: false, status: "live" },
  // Specialized
      ...
      /* @__PURE__ */ jsxRuntime.jsx("div", { className: "grid grid-cols-4 gap-1.5", children: items.map(
        ({ key, label: svcLabel, href, Icon, status, color }) => href ? /* @__PURE__ */ jsxRuntime.jsxs(
          "a",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntime.jsx("div", { className: `flex h-10 w-10 items-center justify-center rounded-xl transition-colors ${ACCENT_CLASSES[color]}`, children: /* @__PURE__ */ jsxRuntime.jsx(Icon, { className: "h-5 w-5" }) }),
              /* @__PURE__ */ jsxRuntime.jsx("span", { className: "w-full text-xs font-semibold leading-tight text-foreground", children: svcLabel })
            ]
          },
          key
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntime.jsx("div", { className: `flex h-10 w-10 items-center justify-center rounded-xl ${ACCENT_CLASSES[color]}`, children: /* @__PURE__ */ jsxRuntime.jsx(Icon, { className: "h-5 w-5" }) }),
              /* @__PURE__ */ jsxRuntime.jsx("span", { className: "w-full text-xs font-semibold leading-tight text-foreground", children: svcLabel }),
              status === "coming-soon" && /* @__PURE__ */ jsxRuntime.jsx("span", { className: "rounded-full bg-secondary px-1.5 py-0.5 text-[9px] font-bold uppercase tracking-wider text-muted-foreground", children: "Soon" })
            ]
          },
          key
        )
