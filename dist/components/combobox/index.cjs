...
function MultiSelectCombobox({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { ref, className: cx2("relative", className), children: [
    /* @__PURE__ */ jsxRuntime.jsxs(
      "button",
      {
        type: "button",
        ...
        children: [
          selected.length === 0 && /* @__PURE__ */ jsxRuntime.jsx("span", { className: "px-0.5 text-muted-foreground", children: placeholder }),
          selected.map((o) => /* @__PURE__ */ jsxRuntime.jsxs(
            "span",
            {
          ...
          /* @__PURE__ */ jsxRuntime.jsx(lucideReact.ChevronsUpDown, { className: "ml-auto h-4 w-4 shrink-0 text-muted-foreground" })
        ]
      }
    ),
    open && panelPos && /* @__PURE__ */ jsxRuntime.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsx("ul", { className: "max-h-60 overflow-y-auto py-1", children: matches.length === 0 ? /* @__PURE__ */ jsxRuntime.jsx("li", { className: "px-3 py-6 text-center text-sm text-muted-foreground", children: emptyText }) : matches.map((o) => {
