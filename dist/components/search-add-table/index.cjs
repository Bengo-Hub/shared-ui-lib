...
function SearchAddTable({
  ...
  const list = /* @__PURE__ */ jsxRuntime.jsx("ul", { className: "max-h-60 overflow-y-auto py-1", children: loading ? /* @__PURE__ */ jsxRuntime.jsxs("li", { className: "flex items-center justify-center gap-2 px-3 py-6 text-sm text-muted-foreground", children: [
    ...
    " Searching\u2026"
  ] }) : visible.length === 0 ? /* @__PURE__ */ jsxRuntime.jsx("li", { className: "px-3 py-6 text-center text-sm text-muted-foreground", children: emptyText }) : visible.map((option) => /* @__PURE__ */ jsxRuntime.jsx("li", { children: /* @__PURE__ */ jsxRuntime.jsxs(
    "button",
    {
      type: "button",
      onMouseDown: (e) => {
      ...
      children: [
        /* @__PURE__ */ jsxRuntime.jsxs("span", { className: "min-w-0", children: [
          /* @__PURE__ */ jsxRuntime.jsxs("span", { className: "flex items-baseline gap-2", children: [
            /* @__PURE__ */ jsxRuntime.jsx("span", { className: "truncate text-foreground", children: option.label }),
            option.hint && /* @__PURE__ */ jsxRuntime.jsx("span", { className: "shrink-0 font-mono text-xs text-muted-foreground", children: option.hint })
          ] }),
          option.description && /* @__PURE__ */ jsxRuntime.jsx("span", { className: "block truncate text-xs text-muted-foreground", children: option.description })
        ] }),
        /* @__PURE__ */ jsxRuntime.jsx(lucideReact.Plus, { className: "h-4 w-4 shrink-0 text-primary" })
      ]
    }
  ) }, option.id)) });
...
exports.SearchAddTable = SearchAddTable;
