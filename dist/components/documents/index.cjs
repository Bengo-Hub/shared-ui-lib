...
function PdfPreview({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "fixed inset-0 z-50 flex items-center justify-center", role: "dialog", "aria-modal": "true", "aria-label": title, children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsx("div", { className: "absolute inset-0 bg-black/50", onClick: () => onOpenChange(false) }),
    /* @__PURE__ */ jsxRuntime.jsxs(
      "div",
      {
        ...
        style: { maxWidth },
        children: [
          /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center justify-between gap-4 border-b px-5 py-3", children: [
            /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "min-w-0", children: [
              /* @__PURE__ */ jsxRuntime.jsx("h2", { className: "truncate text-base font-semibold text-gray-900", children: title }),
              /* @__PURE__ */ jsxRuntime.jsx("p", { className: "truncate font-mono text-xs text-gray-500", children: fileName })
            ] }),
          ...
          /* @__PURE__ */ jsxRuntime.jsx("div", { className: "relative min-h-0 flex-1 bg-gray-100", children: isLoading ? /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex h-full flex-col items-center justify-center gap-3 text-gray-500", children: [
            /* @__PURE__ */ jsxRuntime.jsx(Spinner, {}),
            /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-sm", children: "Generating document\u2026" })
          ] }) : previewUrl ? /* @__PURE__ */ jsxRuntime.jsx("iframe", { src: previewUrl, title, className: "h-full w-full border-0" }) : blob ? /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex h-full flex-col items-center justify-center gap-3 text-center text-gray-500", children: [
            /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-sm", children: "Preview is not available for this file." }),
            /* @__PURE__ */ jsxRuntime.jsxs(
              "button",
              {
          ...
          /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center justify-end gap-2 border-t px-5 py-3", children: [
            /* @__PURE__ */ jsxRuntime.jsx(
              "button",
              {
                onClick: () => onOpenChange(false),
