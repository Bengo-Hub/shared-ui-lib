import { Truck, Warehouse, BedDouble, Wine, Coffee, Scissors, Pill, ShoppingBag, Zap, UtensilsCrossed, Delete, CornerDownLeft, ArrowBigUp, Building2, ChevronRight, ArrowRight, WifiOff, Lock } from 'lucide-react';
...
function QwertyKeyboard({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex w-full flex-col gap-1.5 sm:gap-2", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex gap-1.5 sm:gap-2", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex gap-1.5 sm:gap-2 px-3", children: [
...
function PinLoginHeader({
  ...
  return /* @__PURE__ */ jsx("div", { className: cx("relative z-10 px-5 sm:px-8 pt-5 pb-4 shrink-0", className), children: /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between gap-4", children: [
    /* @__PURE__ */ jsxs("div", { className: "min-w-0", children: [
      /* @__PURE__ */ jsx("p", { className: "text-[10px] font-bold uppercase tracking-[0.25em] text-white/65", children: serviceName }),
      /* @__PURE__ */ jsx("h1", { className: "text-xl sm:text-2xl font-black text-white tracking-tight leading-tight truncate", children: tenantName }),
      (outletName || showSwitchOutlet) && /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 flex-wrap mt-1.5", children: [
        outletName && /* @__PURE__ */ jsx("span", { className: "text-sm font-semibold text-white/85 truncate max-w-[16rem]", children: outletName }),
        isHQ && /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-bold bg-white/15 text-white ring-1 ring-inset ring-white/20", children: [
          /* @__PURE__ */ jsx(Building2, { className: "h-2.5 w-2.5" }),
          "HQ"
        ] }),
...
function PinLoginBrandPanel({ tenantName, tenantLogoUrl, workflowSteps, className }) {
  return /* @__PURE__ */ jsxs("div", { className: `flex flex-col items-center justify-center gap-8 px-6 py-8 text-center ${className ?? ""}`, children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center gap-4", children: [
      ...
      /* @__PURE__ */ jsx(CodevertexMark, { className: "text-white/50" })
    ] })
  ] });
}
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "relative z-10 flex flex-col h-full min-h-0", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex-1 min-h-0 grid grid-cols-1 lg:grid-cols-[minmax(260px,340px)_1fr]", children: [
            brandPanel && /* @__PURE__ */ jsx("div", { className: "hidden lg:flex min-h-0", children: brandPanel }),
            /* @__PURE__ */ jsx("div", { className: "min-h-0 flex items-stretch justify-center p-3 sm:p-5 lg:p-6", children: /* @__PURE__ */ jsx("div", { className: "w-full max-w-5xl bg-card rounded-3xl shadow-2xl ring-1 ring-black/5 flex flex-col min-h-0 overflow-hidden", children: card }) })
          ] })
        ] }),
        footer
      ]
...
export { CodevertexMark, DemoHints, OutletCard, PasscodeField, PinKeypad, PinLoginBrandPanel, PinLoginHeader, PinLoginLayout, QwertyKeyboard, USE_CASE_COLORS, USE_CASE_ICONS, USE_CASE_LABELS, WorkflowIllustration };
