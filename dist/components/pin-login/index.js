...
function PinLoginBrandPanel({
  ...
  return /* @__PURE__ */ jsxs("div", { className: `flex flex-col items-center justify-center gap-8 px-6 py-8 text-center ${className ?? ""}`, children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 rounded-2xl bg-card px-4 py-3 shadow-lg ring-1 ring-black/5", children: [
      /* @__PURE__ */ jsx(
        "img",
        {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "relative z-10 flex flex-col h-full min-h-0", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex-1 min-h-0 grid grid-cols-1 lg:grid-cols-[minmax(260px,340px)_1fr]", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "min-h-0 flex items-stretch justify-center p-2 sm:p-5 lg:p-6", children: /* @__PURE__ */ jsx("div", { className: "w-full max-w-5xl bg-card rounded-2xl sm:rounded-3xl shadow-2xl ring-1 ring-black/5 flex flex-col min-h-0 overflow-hidden", children: card }) })
          ] })
        ] }),
        footer
      ]
