...
function PinKeypad({
  ...
  const NumberKey = (key) => /* @__PURE__ */ jsxRuntime.jsx(
    "button",
    {
      ...
      children: isSubmitting && digitsLength === pinLength ? /* @__PURE__ */ jsxRuntime.jsx("span", { className: "h-2.5 w-2.5 rounded-full bg-white/80 animate-pulse" }) : key
    },
    key
  );
    ...
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "grid grid-cols-3 gap-2.5 sm:gap-3", children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsx(
        "button",
        {
          ...
          children: /* @__PURE__ */ jsxRuntime.jsx(lucideReact.Delete, { className: "h-6 w-6" })
        }
      )
    ] }),
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex w-full flex-col gap-1.5 sm:gap-2", children: [
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex gap-1 sm:gap-2", children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsx(
        ...
        {
          char: "backspace",
          label: /* @__PURE__ */ jsxRuntime.jsx(lucideReact.Delete, { className: "h-4 w-4" }),
          disabled,
          onPress: onBackspace,
    ...
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex gap-1 sm:gap-2 px-1 sm:px-3", children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsx(
        ...
        {
          char: "enter",
          label: /* @__PURE__ */ jsxRuntime.jsxs("span", { className: "flex items-center gap-1 text-xs font-bold", children: [
            /* @__PURE__ */ jsxRuntime.jsx(lucideReact.CornerDownLeft, { className: "h-3.5 w-3.5" }),
            "Enter"
          ] }),
          disabled,
          onPress: onEnter,
    ...
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex gap-1 sm:gap-2", children: [
      /* @__PURE__ */ jsxRuntime.jsx(
        ...
        {
          char: "shift-l",
          label: /* @__PURE__ */ jsxRuntime.jsx(lucideReact.ArrowBigUp, { className: "h-4 w-4" }),
          disabled,
      ...
      QWERTY_ROWS[2].map((c) => /* @__PURE__ */ jsxRuntime.jsx(KbdKey, { char: c, label: cased(c), disabled, onPress: () => onKey(cased(c)) }, c)),
      /* @__PURE__ */ jsxRuntime.jsx(KbdKey, { char: "comma", label: ",", disabled, onPress: () => onKey(","), className: "bg-muted/60" }),
      /* @__PURE__ */ jsxRuntime.jsx(KbdKey, { char: "period", label: ".", disabled, onPress: () => onKey("."), className: "bg-muted/60" }),
      /* @__PURE__ */ jsxRuntime.jsx(
        KbdKey,
        {
          char: "shift-r",
    ...
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex gap-1 sm:gap-2", children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsx(
        ...
        {
          char: "space",
          label: /* @__PURE__ */ jsxRuntime.jsx("span", { className: "text-[11px] font-semibold uppercase tracking-[0.3em] text-muted-foreground", children: "Space" }),
          disabled,
          onPress: () => onKey(" "),
          className: "flex-1"
        }
...
var USE_CASE_ICONS = {
  hospitality: lucideReact.UtensilsCrossed,
  quick_service: lucideReact.Zap,
  retail: lucideReact.ShoppingBag,
  pharmacy: lucideReact.Pill,
  services: lucideReact.Scissors,
  cafe: lucideReact.Coffee,
  bar: lucideReact.Wine,
  hotel: lucideReact.BedDouble,
  warehouse: lucideReact.Warehouse,
  logistics: lucideReact.Truck
};
function OutletCard({
  outlet,
  index,
  ...
  const OutletIcon = (outlet.use_case ? USE_CASE_ICONS[outlet.use_case] : void 0) ?? lucideReact.Building2;
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "button",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "p-5 flex flex-col gap-4", children: [
          /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-start justify-between", children: [
            /* @__PURE__ */ jsxRuntime.jsx(
              "div",
              {
                ...
                children: /* @__PURE__ */ jsxRuntime.jsx(OutletIcon, { className: cx("h-5 w-5 transition-transform duration-200 group-hover:scale-110", color.text) })
              }
            ),
            /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex flex-col items-end gap-1.5", children: [
              outlet.is_hq && /* @__PURE__ */ jsxRuntime.jsx("span", { className: "px-2 py-0.5 rounded-full text-[9px] font-black bg-muted text-muted-foreground uppercase tracking-widest", children: "HQ" }),
          ...
          /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-end justify-between gap-2", children: [
            /* @__PURE__ */ jsxRuntime.jsx("p", { className: "font-bold text-foreground text-sm sm:text-base leading-snug transition-colors", children: outlet.name }),
            /* @__PURE__ */ jsxRuntime.jsx(lucideReact.ChevronRight, { className: "h-4 w-4 text-muted-foreground/50 group-hover:text-muted-foreground group-hover:translate-x-0.5 transition-all shrink-0 mb-0.5" })
          ] })
        ] })
      ]
    }
...
function CodevertexMark({ className }) {
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: `flex items-center gap-2 ${className ?? ""}`, children: [
    /* @__PURE__ */ jsxRuntime.jsxs("svg", { viewBox: "0 0 32 32", className: "h-5 w-5 shrink-0", "aria-hidden": true, children: [
      /* @__PURE__ */ jsxRuntime.jsx("rect", { x: "1", y: "1", width: "30", height: "30", rx: "9", fill: "currentColor", opacity: "0.14" }),
      /* @__PURE__ */ jsxRuntime.jsx(
        "path",
        {
      ...
      /* @__PURE__ */ jsxRuntime.jsx("circle", { cx: "23", cy: "16", r: "1.8", fill: "currentColor" })
    ] }),
    /* @__PURE__ */ jsxRuntime.jsx("span", { className: "text-[11px] font-black uppercase tracking-[0.2em]", children: "Codevertex" })
  ] });
}
function WorkflowIllustration({ steps }) {
  return /* @__PURE__ */ jsxRuntime.jsx("div", { className: "flex items-start justify-center gap-1 sm:gap-2", children: steps.map((step, i) => {
    const Icon = step.icon;
    return /* @__PURE__ */ jsxRuntime.jsxs(React__default.default.Fragment, { children: [
      /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex flex-col items-center gap-1.5 w-16 sm:w-20", children: [
        /* @__PURE__ */ jsxRuntime.jsx("div", { className: "h-9 w-9 sm:h-10 sm:w-10 rounded-xl bg-white/10 ring-1 ring-inset ring-white/15 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntime.jsx(Icon, { className: "h-4 w-4 sm:h-4.5 sm:w-4.5 text-white/85" }) }),
        /* @__PURE__ */ jsxRuntime.jsx("span", { className: "text-[9px] font-semibold uppercase tracking-wide text-white/55 text-center leading-tight", children: step.label })
      ] }),
      i < steps.length - 1 && /* @__PURE__ */ jsxRuntime.jsx(lucideReact.ArrowRight, { className: "h-3.5 w-3.5 text-white/25 shrink-0 mt-2.5" })
    ] }, i);
  }) });
}
...
function PinLoginBrandPanel({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: `h-full flex flex-col items-center justify-center gap-7 px-6 py-8 text-center ${className ?? ""}`, children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsx(PoweredByBadge, { iconUrl: poweredByLogoUrl, layout: "stacked", iconClassName: "h-12 w-12" })
  ] });
}
function PasscodeField({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: cx("flex items-center justify-center gap-2.5 sm:gap-3", className), children: [
    /* @__PURE__ */ jsxRuntime.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntime.jsx(lucideReact.Lock, { className: cx("h-4 w-4 shrink-0", error ? "text-destructive" : "text-muted-foreground") }),
          value.length === 0 ? /* @__PURE__ */ jsxRuntime.jsx("span", { className: "text-sm font-medium text-muted-foreground", children: placeholder }) : /* @__PURE__ */ jsxRuntime.jsx("div", { className: "flex items-center gap-1.5", children: Array.from({ length: value.length }).map((_, i) => /* @__PURE__ */ jsxRuntime.jsx(
            "span",
            {
          ...
          onChange && /* @__PURE__ */ jsxRuntime.jsx(
            "input",
            {
              ref: inputRef,
...
function DemoHints({ title = "Demo PINs", subtitle, hints }) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("div", { className: "absolute bottom-4 right-4 z-30 hidden sm:block", children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "rounded-2xl border border-border bg-card/90 backdrop-blur-xl shadow-lg p-3 max-w-[220px]", children: [
    /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-[9px] font-black text-muted-foreground uppercase tracking-widest mb-1", children: title }),
    subtitle && /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-[8px] text-muted-foreground/70 uppercase tracking-wider mb-2", children: subtitle }),
    /* @__PURE__ */ jsxRuntime.jsx("div", { className: "grid grid-cols-2 gap-1", children: hints.map(({ pin, role, accent }) => /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center gap-1.5 px-2 py-1 rounded-lg", style: { background: `${accent}14` }, children: [
      /* @__PURE__ */ jsxRuntime.jsx("span", { className: "font-mono text-[11px] font-black", style: { color: accent }, children: pin }),
      /* @__PURE__ */ jsxRuntime.jsx("span", { className: "text-[10px] text-muted-foreground truncate", children: role })
    ] }, pin)) })
  ] }) });
}
function PinLoginLayout({ header, brandPanel, card, footer, backdropUrl, className }) {
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "div",
    {
      ...
      children: [
        backdropUrl && /* @__PURE__ */ jsxRuntime.jsx("img", { src: backdropUrl, alt: "", "aria-hidden": true, className: "absolute inset-0 h-full w-full object-cover opacity-20" }),
        /* @__PURE__ */ jsxRuntime.jsx(
          "div",
          {
...
exports.CodevertexMark = CodevertexMark;
exports.DemoHints = DemoHints;
exports.OutletCard = OutletCard;
exports.PasscodeField = PasscodeField;
exports.PinKeypad = PinKeypad;
...
exports.USE_CASE_LABELS = USE_CASE_LABELS;
exports.WorkflowIllustration = WorkflowIllustration;
