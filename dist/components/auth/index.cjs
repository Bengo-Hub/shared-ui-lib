...
function SSOCallbackError({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "sce-wrap", children: [
    /* @__PURE__ */ jsxRuntime.jsx("style", { children: `
      ...
      ` }),
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "sce-card", role: "alert", children: [
      /* @__PURE__ */ jsxRuntime.jsx("div", { className: "sce-icon", children: /* @__PURE__ */ jsxRuntime.jsx(lucideReact.AlertTriangle, { size: 22, color: "#d97706" }) }),
      /* @__PURE__ */ jsxRuntime.jsx("h1", { className: "sce-title", children: title }),
      /* @__PURE__ */ jsxRuntime.jsx("p", { className: "sce-msg", children: message }),
      error && /* @__PURE__ */ jsxRuntime.jsxs("p", { className: "sce-code", children: [
        "(",
        error,
        ")"
      ] }),
      /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "sce-actions", children: [
        /* @__PURE__ */ jsxRuntime.jsxs("button", { type: "button", className: "sce-btn sce-btn-primary", onClick: onRetry, children: [
          /* @__PURE__ */ jsxRuntime.jsx(lucideReact.RefreshCcw, { size: 15 }),
          "Sign in again"
        ] }),
        showRescue && /* @__PURE__ */ jsxRuntime.jsxs(
          "button",
          {
            type: "button",
            ...
            children: [
              /* @__PURE__ */ jsxRuntime.jsx(lucideReact.Building2, { size: 15 }),
              "Continue to ",
              lastKnownTenant,
              /* @__PURE__ */ jsxRuntime.jsx(lucideReact.ArrowRight, { size: 15 })
            ]
          }
        )
      ] })
...
function VerifyEmailBanner({ state, verifyUrl, onSendCode, onVerifyCode, onVerified }) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    /* @__PURE__ */ jsxRuntime.jsx("div", { className: `border-b ${BANNER_STYLES[stage]}`, role: "alert", children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: `mx-auto flex max-w-6xl items-center gap-3 px-4 py-2.5 ${TEXT_STYLES[stage]}`, children: [
      ...
      linkMode ? /* @__PURE__ */ jsxRuntime.jsxs(
        "a",
        {
          href: verifyUrl,
          target: "_blank",
    ...
    open && onSendCode && onVerifyCode && /* @__PURE__ */ jsxRuntime.jsx(
      VerifyEmailDialog,
      {
        state,
        onSendCode,
...
function OtpInput({
  ...
  const digits = React__namespace.useMemo(() => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("div", { className: "veb-otp", children: digits.map((d, i) => /* @__PURE__ */ jsxRuntime.jsx(
    "input",
    {
      ref: (el) => {
        refs.current[i] = el;
...
function VerifyEmailDialog({ state, onSendCode, onVerifyCode, onVerified, onClose, embedded }) {
  ...
  const [sending, setSending] = React__namespace.useState(false);
  const [verifying, setVerifying] = React__namespace.useState(false);
  const [error, setError] = React__namespace.useState(null);
  const [resent, setResent] = React__namespace.useState(false);
  const [cooldown, setCooldown] = React__namespace.useState(0);
  React__namespace.useEffect(() => {
  ...
  const doSend = React__namespace.useCallback(async (isResend) => {
    setError(null);
  ...
  const doVerify = React__namespace.useCallback(async (full) => {
    setError(null);
    setResent(false);
    if (full.length !== 6) {
  ...
  const card = /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "veb-card", role: "dialog", "aria-modal": "true", "aria-label": "Verify your email", children: [
    /* @__PURE__ */ jsxRuntime.jsx("div", { className: "veb-icon", children: /* @__PURE__ */ jsxRuntime.jsx(lucideReact.Mail, { className: "size-6" }) }),
    /* @__PURE__ */ jsxRuntime.jsx("h2", { className: "veb-title", children: s.is_placeholder ? "Add a real email address" : "Verify your email" }),
    /* @__PURE__ */ jsxRuntime.jsx("p", { className: "veb-sub", children: !sent ? s.is_placeholder ? "Your account was set up without a reachable email. Add yours below \u2014 we\u2019ll send a 6-digit code, and it will replace the placeholder on your account." : "Confirm this address is yours so we can send receipts, alerts and password resets, and so you can recover your account." : /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
      "We sent a 6-digit code to ",
      /* @__PURE__ */ jsxRuntime.jsx("b", { children: email }),
      "."
    ] }) }),
    stage === "final_warning" && /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "veb-alert veb-alert-warn", children: [
    ...
    stage === "enforced" && /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "veb-alert veb-alert-warn", children: [
    ...
    !sent ? /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
      /* @__PURE__ */ jsxRuntime.jsx("label", { className: "veb-label", htmlFor: "veb-email", children: "Email address" }),
      /* @__PURE__ */ jsxRuntime.jsx(
        "input",
        {
          id: "veb-email",
      ...
      error && /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "veb-err", children: [
        /* @__PURE__ */ jsxRuntime.jsx(lucideReact.AlertTriangle, { className: "size-4", style: { flexShrink: 0, marginTop: 1 } }),
        /* @__PURE__ */ jsxRuntime.jsx("span", { children: error })
      ] }),
      /* @__PURE__ */ jsxRuntime.jsx("button", { className: "veb-btn", onClick: () => doSend(false), disabled: busy, children: sending ? /* @__PURE__ */ jsxRuntime.jsx(lucideReact.Loader2, { className: "size-5 veb-spin" }) : /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
        "Send code ",
        /* @__PURE__ */ jsxRuntime.jsx(lucideReact.ArrowRight, { className: "size-4" })
      ] }) })
    ] }) : /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
      /* @__PURE__ */ jsxRuntime.jsx("label", { className: "veb-label", style: { textAlign: "center" }, children: "Enter the code" }),
      /* @__PURE__ */ jsxRuntime.jsx(OtpInput, { value: code, onChange: setCode, onComplete: doVerify, disabled: verifying }),
      error && /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "veb-err", children: [
        /* @__PURE__ */ jsxRuntime.jsx(lucideReact.AlertTriangle, { className: "size-4", style: { flexShrink: 0, marginTop: 1 } }),
        /* @__PURE__ */ jsxRuntime.jsx("span", { children: error })
      ] }),
      resent && !error && /* @__PURE__ */ jsxRuntime.jsx("p", { className: "veb-ok", children: "A new code has been sent." }),
      /* @__PURE__ */ jsxRuntime.jsx("button", { className: "veb-btn", onClick: () => doVerify(code), disabled: busy || code.length !== 6, children: verifying ? /* @__PURE__ */ jsxRuntime.jsx(lucideReact.Loader2, { className: "size-5 veb-spin" }) : /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
        /* @__PURE__ */ jsxRuntime.jsx(lucideReact.CheckCircle2, { className: "size-4" }),
        " Verify & Continue"
      ] }) }),
      /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "veb-foot", children: [
        "Didn't get it?",
        " ",
        /* @__PURE__ */ jsxRuntime.jsx("button", { className: "veb-link", onClick: () => doSend(true), disabled: sending || cooldown > 0, children: cooldown > 0 ? `Resend in ${cooldown}s` : sending ? "Sending\u2026" : "Resend code" }),
        " \xB7 ",
        /* @__PURE__ */ jsxRuntime.jsx("button", { className: "veb-link", onClick: changeEmail, disabled: busy, children: "Change email" })
      ] })
    ] }),
    canClose && /* @__PURE__ */ jsxRuntime.jsx("button", { className: "veb-later", onClick: onClose, children: "Later" }),
    !embedded && !canClose && stage === "enforced" && /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "veb-wait", children: [
      "You can continue in ",
      wait,
      "s"
    ] })
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("div", { className: "veb-overlay", children: card });
}

exports.SSOCallbackError = SSOCallbackError;
