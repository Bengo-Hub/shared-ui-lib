      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "mx-auto flex max-w-6xl items-center gap-3 px-4 py-2", children: [
            isUrgent ? /* @__PURE__ */ jsxRuntime.jsx(lucideReact.RefreshCw, { className: "size-3.5 shrink-0", style: { color: accent } }) : /* @__PURE__ */ jsxRuntime.jsx(lucideReact.Zap, { className: "size-3.5 shrink-0", style: { color: accent } }),
            /* @__PURE__ */ jsxRuntime.jsx("span", { className: ["text-sm font-semibold", isUrgent ? "text-amber-900 dark:text-amber-100" : "text-foreground"].join(" "), children: planLabel }),
            renewalText && /* @__PURE__ */ jsxRuntime.jsxs("span", { className: ["text-xs hidden sm:inline", isUrgent ? "text-amber-700 dark:text-amber-300" : "text-muted-foreground"].join(" "), children: [
              "\xB7 ",
              renewalText
            ] }),
            /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "ml-auto flex items-center gap-2", children: [
              !isPerpetual && /* @__PURE__ */ jsxRuntime.jsxs(
                "a",
                {
          ...
          expanded && /* @__PURE__ */ jsxRuntime.jsx("div", { className: ["mx-auto max-w-6xl border-t px-4 py-3", isUrgent ? "border-amber-200 dark:border-amber-800" : "border-border/50"].join(" "), children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex flex-wrap items-center gap-x-6 gap-y-2 text-xs text-muted-foreground", children: [
            ...
            /* @__PURE__ */ jsxRuntime.jsxs("span", { children: [
              ...
              " ",
              isUrgent ? /* @__PURE__ */ jsxRuntime.jsx("span", { className: "text-amber-700 dark:text-amber-300 font-medium", children: "Renews soon" }) : /* @__PURE__ */ jsxRuntime.jsx("span", { className: "capitalize", children: normalizedStatus.toLowerCase() })
            ] }),
            isPerpetual ? /* @__PURE__ */ jsxRuntime.jsxs("span", { children: [
              /* @__PURE__ */ jsxRuntime.jsx("span", { className: "font-medium text-foreground", children: "Licence" }),
              " ",
