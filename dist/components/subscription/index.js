      ...
      children: /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxs("p", { className: "text-sm text-foreground", children: [
              /* @__PURE__ */ jsx("span", { className: "font-semibold", children: serviceLabel }),
              " ",
...
function ServiceLock({ serviceTag, mode = "block", children, className, title, description }) {
  ...
  const dialog = /* @__PURE__ */ jsx(ServiceUpgradeDialog, { serviceTag, open: dialogOpen, onClose: () => setDialogOpen(false), title, description });
  if (mode === "badge") {
    return /* @__PURE__ */ jsxs(Fragment, { children: [
      /* @__PURE__ */ jsxs(
        "span",
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center gap-3 rounded-2xl border border-amber-500/30 bg-amber-500/5 px-6 py-12 text-center " + (className ?? ""), children: [
    /* @__PURE__ */ jsx("span", { className: "flex h-12 w-12 items-center justify-center rounded-2xl bg-amber-500/15 text-amber-500", children: /* @__PURE__ */ jsx(Lock, { className: "h-6 w-6" }) }),
    /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
      /* @__PURE__ */ jsx("p", { className: "text-base font-bold text-foreground", children: title ?? "This service needs an upgrade" }),
      /* @__PURE__ */ jsx("p", { className: "max-w-md text-sm text-muted-foreground", children: description ?? `This service is not included in your current plan. Available on ${tierLabel}.` })
    ] }),
    /* @__PURE__ */ jsxs(
      "button",
      {
