...
function DataTable(props) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: cx2("space-y-3", props.className), children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "hidden md:block overflow-x-auto rounded-lg border border-border", children: [
      /* @__PURE__ */ jsxRuntime.jsxs("table", { className: "w-full text-sm", children: [
        /* @__PURE__ */ jsxRuntime.jsx("thead", { children: /* @__PURE__ */ jsxRuntime.jsxs("tr", { className: cx2("border-b border-border bg-muted/40", gridLines === "both" && "divide-x divide-border/50"), children: [
          ...
          visibleColumns.map((col) => /* @__PURE__ */ jsxRuntime.jsx(
            "th",
            {
              ...
              children: /* @__PURE__ */ jsxRuntime.jsxs("span", { className: cx2("inline-flex items-center gap-1", col.align === "right" && "flex-row-reverse"), children: [
                col.header,
    ...
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "md:hidden rounded-lg border border-border", children: [
      /* @__PURE__ */ jsxRuntime.jsx("div", { className: "divide-y divide-border", children: loading ? /* @__PURE__ */ jsxRuntime.jsx("div", { className: "px-6 py-12 text-center text-muted-foreground", children: "Loading\u2026" }) : error ? /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "px-6 py-12 text-center", children: [
        /* @__PURE__ */ jsxRuntime.jsx(lucideReact.AlertTriangle, { className: "h-10 w-10 mx-auto text-destructive/60 mb-3" }),
        /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-muted-foreground", children: "Couldn't load data" }),
        onRetry && /* @__PURE__ */ jsxRuntime.jsx(
          "button",
